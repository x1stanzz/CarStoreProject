...
private val LocalBackPressedDespatcher =
...
internal fun ComposableHandler(
    ...
    val dispatcher = (LocalBackPressedDespatcher.current ?: return).onBackPressedDispatcher
...
internal fun SystemBackButtonHandler(onBackPressed: () -> Unit) {
    CompositionLocalProvider(
        LocalBackPressedDespatcher provides LocalLifecycleOwner.current as ComponentActivity
    ) {
        ComposableHandler {
            onBackPressed()
        }
